...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    const prompt = `Streszczenie rynkowe na temat: ${input}

Dostarcz neutralne, edukacyjne streszczenie bez spekulacji czy prognoz.
Skup się na faktach i ogólnych trendach.
